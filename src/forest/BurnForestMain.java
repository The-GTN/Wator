...
/** Main class for the BurnForest
* @author Nollet Antoine
* @version 03/06/2020
*/
public class BurnForestMain {
  ...
  */
  private static void simulation(String[] args) {
    ...
    int perTree = Integer.parseInt(args[2]);

    Forest forest = new Forest(width,height,perTree);
    ...
    if(args.length == 7) {
      displayer = new GraphicalGridDisplayer(width,height,"media/pictures/iconeForest.png");
    ...
    BurnForest bf = new BurnForest(displayer,forest);
    displaySimalution(bf,steps,displayPeriod);
  ...
  */
  private static void displaySimalution(BurnForest bf, int steps, int displayPeriod) {
  ...
  */
  private static void errorMessage() {
    System.out.println("run with java forest.BurnForest w h pt s dp [display [squSz]]");
    System.out.println("where:");
    System.out.println("w       = width of environment (chose value<100)");
    System.out.println("h       = height of environment (chose value<100)");
    System.out.println("pt      = percentage of trees at beginning");
    ...
    System.out.println("java forest.BurnForest 30 30 60 100 1 g 10");
    System.out.println("or");
    System.out.println("java forest.BurnForest 25 25 70 150 1 g 20");
  }
